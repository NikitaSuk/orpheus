        ...
        <div className="p-4 border-b border-gray-700">
          <div className="flex flex-col space-y-2">
            ...
            <Link
              ...
              className="text-sm py-3 px-4 bg-transparent rounded-xl hover:bg-gray-700"
            >
              Notifications
            </Link>
            <Link
            ...
            <Link
              to="/marketplace/buying"
              className="text-sm py-3 px-4 bg-transparent rounded-xl hover:bg-gray-700"
            >
              Buying
            </Link>
            <Link
              to="/marketplace/selling"
              className="text-sm py-3 px-4 bg-transparent rounded-xl hover:bg-gray-700"
            >
              Selling
            </Link>
            ...
            {categories.map((category, index) => (
              <li key={index}>
                <Link
                  ...
                  className="block py-3 px-4 bg-gray-900 text-white rounded-xl hover:bg-gray-700"
                >
                  {category}
                </Link>
              </li>
